...
export const CAREER_POSITIONS = [
  ...
  },
  {
    ...
    type: 'Full-time',
    experience: '0+ years',
    description: 'Lead product strategy and development for our IoT platform.',
    requirements: [
      '3+ years of product management experience',
      'Experience with IoT or SaaS products',
  ...
  },
  {
    ...
    type: 'Full-time',
    experience: '0+ years',
    description: 'Build beautiful and responsive user interfaces for our IoT platform.',
    requirements: [
  ...
  },
  {
    ...
    type: 'Full-time',
    experience: '0+ years',
    description: 'Drive business growth by identifying and closing new opportunities.',
    requirements: [
      '4+ years of B2B sales experience',
      'Experience in IoT, SaaS, or smart city solutions',
  ...
  },
  {
    ...
    type: 'Full-time',
    experience: '0+ years',
    description: 'Design intuitive and engaging user experiences for our IoT platform.',
    requirements: [
  ...
  },
  {
    ...
    type: 'Full-time',
    experience: '0+ years',
    description: 'Start your career in IoT development with our growing engineering team.',
    requirements: [
  ...
  },
  {
    ...
    type: 'Full-time',
    experience: '0+ years',
    description: 'Drive digital marketing campaigns to promote our IoT solutions.',
    requirements: [
    ...
    responsibilities: [
      ...
      'Create engaging content and copy',
